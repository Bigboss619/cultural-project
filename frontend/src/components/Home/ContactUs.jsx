                            ...
                            <div className="card-heritage">
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-[#B85C3C]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-map-pin w-6 h-6 text-[#B85C3C]" data-loc="client/src/components/Contact.tsx:150">
                            ...
                            <div className="card-heritage">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="w-12 h-12 bg-[#D4A574]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-mail w-6 h-6 text-[#D4A574]">
                            ...
                            <div className="card-heritage">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="w-12 h-12 bg-[#2D5016]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-phone w-6 h-6 text-[#2D5016]" >
