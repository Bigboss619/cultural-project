        ...
        <header className="sticky top-0 z-50 bg-white shadow-md border-b border-[#E0D5C7]">
            <div className="flex items-center justify-between h-20 p-6">
                ...
                <nav>
                        ...
                        <Link to="/pricing" className='capitalize px-3 py-2 text-sm font-medium text-[#1A1A1A] hover:text-[#B85C3C] transition-colors duration-300 border-b-2 border-transparent hover:border-[#B8633C]'>Pricing</Link>
